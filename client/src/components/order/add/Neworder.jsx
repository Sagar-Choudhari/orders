                        ...
                        <div className="col-sm-12">
                            <div className="rounded border border-light">
                                <table className="table table-striped rounded">
                                    ...
                                    <tr className='text-center align-center text-align-center'>
                                        <th scope='col' className='pb-2 m-0 text-center text-align-center'>No.</th>
                                        <th scope='col' className='pb-2 m-0 text-center text-align-center'>Item Name</th>
                                        <th scope='col' className='pb-2 m-0 text-center text-align-center'>Quantity</th>
                                        <th scope='col' className='pb-2 m-0 text-center text-align-center'>Rate</th>
                                        <th scope='col' className='pb-2 m-0 text-center text-align-center'>Color</th>
                                        <th scope='col' className='pb-2 m-0 text-center text-align-center'>Specification</th>
                                        <th scope='col' className='pb-2 m-0 text-center text-align-center'>Remark</th>
                                        <th className='text-bottom pb-2'><button type='button' className="btn btn-primary btn-sm" onClick={addTableRows} >AddRow</button></th>
                                    </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <div className="my-2">
                                <button type='button' className="btn btn-primary btn-sm" onClick={addTableRows} >AddRow</button>
                            </div>
